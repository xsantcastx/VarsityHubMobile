...
publicSiteRouter.get('/account-deletion', (_req, res) => {
  res.setHeader('Content-Type', 'text/html');
  res.send(
    `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>VarsityHub - Account Deletion</title><style>${pageStyle}</style></head><body><div class="card"><h1>VarsityHub Account Deletion</h1><p>To delete your VarsityHub account and all associated data, please follow the steps below.</p><h2>How to Delete Your Account</h2><p>You can delete your account directly in the app:</p><ol><li>Open the VarsityHub app</li><li>Go to <strong>Settings</strong></li><li>Tap <strong>Account</strong></li><li>Tap <strong>Delete Account</strong> and confirm</li></ol><p>Your account and the content you created are deleted immediately and permanently &mdash; this cannot be undone. Residual backup copies are purged within 90 days, in accordance with our <a href="/privacy-policy">Privacy Policy</a>.</p><h2>Need Help?</h2><p>If you are unable to access the app, contact us at <a href="mailto:customerservice@varsityhub.app">customerservice@varsityhub.app</a> and we will process your deletion request manually.</p><p>&copy; 2025 Lime Productions. All rights reserved.</p></div></body></html>`
  );
});
