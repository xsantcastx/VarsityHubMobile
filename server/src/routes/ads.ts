...
// Safe to repeat (skips ads already populated). Kept explicit so importing the
// router never mutates data during tests or verification.
export async function runAdsStartupBackfill(): Promise<void> {
  try {
