...
// Minimum total billable units (sport programs) to be a paying Veteran: the
// free floor + 1 (Phase 4 re-unit: programs, not teams).
export const SERVER_VETERAN_MIN_TOTAL_TEAMS = SERVER_ROOKIE_PROGRAM_LIMIT + 1;
