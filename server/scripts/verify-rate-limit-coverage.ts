...
const checks: Check[] = [
  ...
  { file: 'src/routes/payments.ts', mustContain: "paymentsRouter.post('/create-payment-sheet', expressPkg.json(), requireVerified as any, paymentLimiter", label: 'payments payment-sheet limiter' },
  { file: 'src/routes/payments.ts', mustContain: "paymentsRouter.post('/finalize-session', expressPkg.json(), requireVerified as any, paymentLimiter", label: 'payments finalize-session limiter' },
  { file: 'src/routes/payments.ts', mustContain: "paymentsRouter.post('/cancel-intent', expressPkg.json(), requireVerified as any, paymentLimiter", label: 'payments cancel-intent limiter' },
  { file: 'src/routes/payments.ts', mustContain: "paymentsRouter.post('/subscribe', expressPkg.json(), requireVerified as any, paymentLimiter", label: 'payments subscribe limiter' },
  ...
  // Uploads
  { file: 'src/routes/uploads.ts', mustContain: "uploadsRouter.get('/cloudinary-signature', requireAuth as any, uploadLimiter", label: 'uploads cloudinary-signature limiter' },
  { file: 'src/routes/uploads.ts', mustContain: "uploadsRouter.get('/sign', requireAuth as any, uploadLimiter", label: 'uploads sign limiter' },
  { file: 'src/routes/uploads.ts', mustContain: "uploadsRouter.post('/', requireAuth as any, uploadLimiter", label: 'uploads media endpoint limiter' },
  { file: 'src/routes/uploads.ts', mustContain: "uploadsRouter.post('/files', requireAuth as any, uploadLimiter", label: 'uploads files endpoint limiter' },
  { file: 'src/routes/uploads.ts', mustContain: "uploadsRouter.post('/avatar', requireAuth as any, uploadLimiter", label: 'uploads avatar limiter' },
];
