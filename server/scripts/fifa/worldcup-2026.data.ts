...
export const MATCHES: MatchDef[] = [
  ...
  // Confirmed matchups from the concluded group stage. Source: Yahoo Sports
  // (sports.yahoo.com) Round-of-32 bracket, daily schedule, and TV-schedule
  // articles, cross-verified 2026-06-29. Kickoff times converted from ET
  // (EDT = UTC-4). `home` = the official bracket-order (first-named) team.
  // Group-qualification position labels were omitted because the source's
  // labels were internally inconsistent; the matchups themselves agreed across
  // all three sources.
  {
    home: 'South Africa',
    away: 'Canada',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 3:00 PM ET (June 28).',
    isNeutral: true,
    note: 'Final: Canada 1–0.',
  },
  {
    home: 'Brazil',
    away: 'Japan',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 1:00 PM ET (June 29).',
    isNeutral: true,
    note: 'Final: Brazil 2–1.',
  },
  {
    home: 'Germany',
    away: 'Paraguay',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 4:30 PM ET (June 29).',
    isNeutral: true,
  },
  {
    home: 'Netherlands',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 9:00 PM ET (June 29).',
    isNeutral: true,
  },
  {
    home: 'Ivory Coast',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 1:00 PM ET (June 30).',
    isNeutral: true,
  },
  {
    home: 'France',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 5:00 PM ET (June 30).',
    isNeutral: true,
  },
  {
    home: 'Mexico',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 9:00 PM ET (June 30).',
    isNeutral: false,
  },
  {
    home: 'England',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 12:00 PM ET (July 1).',
    isNeutral: true,
  },
  {
    home: 'Belgium',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 4:00 PM ET (July 1).',
    isNeutral: true,
  },
  {
    home: 'USA',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 8:00 PM ET (July 1).',
    isNeutral: false,
  },
  {
    home: 'Spain',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 3:00 PM ET (July 2).',
    isNeutral: true,
  },
  {
    home: 'Portugal',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 7:00 PM ET (July 2).',
    isNeutral: true,
  },
  {
    home: 'Switzerland',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 11:00 PM ET (July 2).',
    isNeutral: true,
  },
  {
    home: 'Australia',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 2:00 PM ET (July 3).',
    isNeutral: true,
  },
  {
    home: 'Argentina',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 6:00 PM ET (July 3).',
    isNeutral: true,
  },
  {
    home: 'Colombia',
    ...
    group: 'Round of 32',
    matchLabel: 'Round of 32',
    kickoffLocalNote: 'Kickoff: 9:30 PM ET (July 3).',
    isNeutral: true,
  },
];
