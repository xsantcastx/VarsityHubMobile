...
export default function RoleOnboardingScreen() {
  ...
  // Veteran Coach actions - paid tier ($1.00/team after first 2)
  const veteranActions: OnboardingAction[] = [
    {
      icon: 'trophy',
      title: 'Unlimited Teams',
      description: 'Add as many teams as you need - $1.00/month each',
      route: '/manage-teams',
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          >
            ...
            <View style={styles.accountTypeInfo}>
              ...
              <Text style={[styles.accountTypePrice, { color: '#7c3aed' }]}>$29.99/year</Text>
              <Text style={[styles.accountTypeDescription, { color: Colors[colorScheme].mutedText }]}>
  ...
  if (accountType === 'fan') {
    ...
    if (coachTier === 'rookie') {
      ...
      welcomeSubtitle = 'Unlimited teams at $1.00/month each (first 2 free)';
