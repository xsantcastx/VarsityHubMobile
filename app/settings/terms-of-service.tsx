    ...
    <SafeAreaView style={[styles.container, { backgroundColor: Colors[colorScheme].background }]} edges={['bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TermSection colorScheme={colorScheme} title="6. Subscriptions"
          body={'Rookie: Free (2 teams). Veteran: $1.50/mo per team. Legend: $20/yr unlimited. Auto-renew unless cancelled. Payments via Stripe/Apple IAP. Refunds case-by-case. Cancel anytime in Settings.'} />
