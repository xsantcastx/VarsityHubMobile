    ...
    <SafeAreaView style={[styles.container, { backgroundColor: Colors[colorScheme].background }]} edges={['bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TermSection colorScheme={colorScheme} title="6. Subscriptions"
          body={'Rookie: Free (2 teams). Veteran: $1/mo per additional team. Legend: $20/yr unlimited. Auto-renew unless cancelled. Payments via Apple IAP (iOS), Google Play (Android), or Stripe. Refunds case-by-case. Cancel anytime in Settings.'} />
