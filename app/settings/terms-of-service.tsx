    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <Ionicons name="flag-outline" size={48} color={theme.tint} />
          <Text style={[styles.title, { color: theme.text }]}>Our Core Values</Text>
        </View>

        {/* Core Values as bullet points, with privacy link */}
        <View style={[styles.card, { backgroundColor: theme.card, borderColor: theme.border }]}> 
          <View style={styles.iconRow}>
            <Ionicons name="flag-outline" size={24} color={theme.tint} />
            <Text style={[styles.cardTitle, { color: theme.text }]}>Core Values</Text>
          </View>
          <View style={{ marginLeft: 8 }}>
            ...
            <Text style={[styles.cardText, { color: theme.mutedText, marginTop: 12 }]}>• <Text style={{ color: theme.tint, textDecorationLine: 'underline' }} onPress={() => { window.open('https://limeprod.com/VarsityHubPrivacy', '_blank'); }}>VarsityHub Privacy Policy</Text></Text>
          </View>
        </View>
