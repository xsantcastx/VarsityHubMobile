...
const createStyles = (colorScheme: 'light' | 'dark') => StyleSheet.create({
  ...
  statusUpcoming: { backgroundColor: colorScheme === 'dark' ? 'rgba(59,130,246,0.3)' : 'rgba(219,234,254,0.95)', borderWidth: 1, borderColor: colorScheme === 'dark' ? 'rgba(59,130,246,0.5)' : '#bfdbfe' },
  statusLive: { backgroundColor: colorScheme === 'dark' ? 'rgba(239,68,68,0.3)' : 'rgba(254,226,226,0.95)', borderWidth: 1, borderColor: colorScheme === 'dark' ? 'rgba(239,68,68,0.5)' : '#fecaca' },
  statusFinal: { backgroundColor: colorScheme === 'dark' ? 'rgba(107,114,128,0.3)' : 'rgba(229,231,235,0.95)', borderWidth: 1, borderColor: colorScheme === 'dark' ? 'rgba(107,114,128,0.5)' : '#d1d5db' },
  ...
  tabBtnCapsuleOn: { backgroundColor: Colors[colorScheme].card, borderWidth: 1, borderColor: Colors[colorScheme].tint },
  tabBtn: { flex: 1, borderRadius: 999, alignItems: 'center', paddingVertical: 8 },
  tabBtnOn: { backgroundColor: Colors[colorScheme].card, borderWidth: 1, borderColor: Colors[colorScheme].tint },
