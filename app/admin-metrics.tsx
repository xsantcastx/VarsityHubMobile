    ...
    <View style={styles.barRow}>
      ...
      <View style={styles.barTrack}>
        <View
          style={[
            styles.barFill,
            { width: `${Math.max(2, (value / maxDaily) * 100)}%`, backgroundColor: color },
          ]}
        />
      </View>
      ...
      >
        ...
        <View style={styles.rangeRow}>
          {([7, 14, 30] as DayRange[]).map(d => (
            ...
            >
              <Text
                style={{
                  color: days === d ? 'white' : palette.text,
                  fontWeight: '700',
                  fontSize: 13,
                }}
              >
        ...
        {loading ? (
          ...
          <View style={{ padding: 24, alignItems: 'center' }}>
            <Text
              style={{ color: colorScheme === 'dark' ? '#FCA5A5' : '#DC2626', fontWeight: '600' }}
            >
              {error}
            </Text>
            <Pressable
          ...
          <>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <StatCard
                ...
                recent={summary.newUsersLastDays || 0}
                color="#3B82F6"
                icon="people"
              />
              <StatCard
                ...
                recent={summary.reportsLastDays || 0}
                color="#EF4444"
                icon="flag"
              />
              <StatCard
                ...
                recent={summary.messagesLastDays || 0}
                color="#8B5CF6"
                icon="chat"
              />
            </View>
            ...
            {/* Daily Charts */}
            <DailyChartSection title="Daily New Users" items={daily?.users} color="#3B82F6" />

            <DailyChartSection title="Daily Messages" items={daily?.messages} color="#8B5CF6" />

            <DailyChartSection title="Daily Reports" items={daily?.reports} color="#EF4444" />
          </>
        ) : null}
      </ScrollView>
    </SafeAreaView>
