...
export default function PublicEventScreen() {
  ...
  const loadEventData = useCallback(async () => {
    ...
    try {
      ...
      const isSampleEvent = eventId && /^sample-/i.test(eventId);
          ...
          <View style={styles.sectionHeader}>
            ...
            <Pressable
              ...
              onPress={() => {
                ...
                const targetGameId = event?.game_id || eventId || '';
                if (__DEV__) console.warn('[PublicEvent] Navigating to create-post with gameId:', targetGameId, '| eventId:', eventId, '| event?.game_id:', event?.game_id);
                router.push({
            ...
            >
              ...
              <Text style={styles.createPostButtonText}>
                {eventId && /^sample-/i.test(eventId) ? 'Add Sample Post' : 'Create Post'}
              </Text>
            </Pressable>
          </View>
