...
const PLAN_OPTIONS: PlanOption[] = [
  {
    id: 'rookie',
    title: 'Rookie',
    priceLabel: 'Free - 2 teams',
    description: 'Perfect for coaches managing up to 2 teams (e.g. Girls & Boys Soccer)',
    extraNote: 'Great for getting started with VarsityHub',
    benefits: ['Manage up to 2 teams', 'Schedule games & events', 'Post updates & highlights', 'Team roster management'],
  },
  {
    id: 'veteran',
    title: 'Veteran',
    priceLabel: '$1.50/month per team (after first 2)',
    description: 'For coaches managing 3+ teams with flexible team-based pricing.',
    badge: 'Most Popular',
    extraNote: 'Pay only for the teams you need. Cancel anytime.',
    benefits: ['First 2 teams free', '$1.50/month per additional team', 'All Rookie features', 'Priority support', 'Advanced analytics'],
  },
  {
    id: 'legend',
    title: 'Legend',
    priceLabel: '$29.99/year - Unlimited',
    description: 'Best value for multi-team programs and organizations.',
    benefits: ['Unlimited teams/clubs', 'All Veteran features', 'Organization management', 'Custom branding', 'Multi-team dashboard'],
  },
];
