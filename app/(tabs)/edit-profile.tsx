...
export default function EditProfileScreen() {
  ...
  const headerUpload = useMediaUpload();
  ...
  const uploadAvatar = async (uri: string) => {
    try {
      ...
      const uploadResult = await avatarUpload.upload(manipulatedImage.uri, 'avatar.jpg', 'image/jpeg');
  ...
  const uploadHeaderImage = async (uri: string) => {
    try {
      ...
      const uploadResult = await headerUpload.upload(manipulatedImage.uri, 'profile-cover.jpg', 'image/jpeg');
      const url = uploadResult?.url || uploadResult?.path;
      if (url) {
              ...
              <View style={styles.avatarSection}>
                ...
                <Pressable 
                  ...
                  style={[styles.changeAvatarButton, { 
                    ...
                    opacity: avatarUpload.uploading ? 0.6 : 1,
                  }]}
                >
              ...
              <View style={styles.bannerSection}>
                ...
                <View style={styles.bannerActions}>
                  <Pressable
                    ...
                    style={[
                      styles.bannerButton,
                      { backgroundColor: Colors[colorScheme].tint, opacity: headerUpload.uploading ? 0.6 : 1 },
                    ]}
                  >
                    <Ionicons name="image" size={16} color="#FFFFFF" />
                    <Text style={styles.bannerButtonText}>
                      {headerUpload.uploading ? 'Uploading...' : headerImageUrl ? 'Change Background' : 'Add Background'}
                    </Text>
                  </Pressable>
                  {headerImageUrl ? (
                    <Pressable
