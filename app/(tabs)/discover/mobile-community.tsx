...
const styles = StyleSheet.create({
  ...
  zipSuggestionList: { marginTop: 6, marginBottom: 8, borderRadius: 12, borderWidth: 1, overflow: 'hidden', shadowColor: '#0f172a', shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  ...
  unifiedSearchResults: { marginTop: 6, marginBottom: 12, borderRadius: 12, borderWidth: 1, overflow: 'hidden', maxHeight: 360 },
  ...
  searchResultRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 12, paddingVertical: 10, borderBottomWidth: 1 },
  ...
  teamPill: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999, backgroundColor: '#EEF2FF', borderWidth: 1, borderColor: '#C7D2FE' },
  teamPillText: { fontWeight: '700', color: '#1E3A8A' },
  vsText: { marginHorizontal: 4, color: '#6b7280', fontWeight: '800' },
  teamPillAlt: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999, backgroundColor: '#DCFCE7', borderWidth: 1, borderColor: '#A7F3D0' },
