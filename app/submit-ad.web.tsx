  ...
  const submit = async () => {
    ...
    try {
      ...
      try {
        ...
        if (__DEV__)
          console.warn('[submit-ad.web] /me prefetch failed:', (err as Error)?.message ?? err);
      }
      ...
      if (!serverId) {
        Alert.alert(
          'Error',
          'Could not create your ad. Please check your connection and try again.'
        );
        return;
      }
      ...
      try {
        ...
        if (__DEV__)
          console.warn(
            '[submit-ad.web] Failed to cache draft locally:',
