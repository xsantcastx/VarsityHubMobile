...
export default function AddGameModal({
  ...
  const [opponentSearchResults, setOpponentSearchResults] = useState<
    { id: string; name: string; sport?: string | null; logo_url?: string | null }[]
  >([]);
  ...
  const validateForm = (): boolean => {
    ...
    if (isPastGameDate(formData.date)) {
                  ...
                  <View style={styles.gameTypeContainer}>
                    {(['home', 'away', 'neutral'] as const).map(type => (
                      <Pressable
                        ...
                        onPress={() => {
                          if (type === 'home') {
                            const teamRaw = (rawTeams as any[]).find(
                              t => t.name === formData.currentTeam
                            );
                            ...
                            setFormData(prev => ({
                              ...
                              ...(homeVenue
                                ? {
                                    location: homeVenue,
                                    ...(teamRaw?.venue_lat != null
                                      ? { latitude: teamRaw.venue_lat }
                                      : {}),
                                    ...(teamRaw?.venue_lng != null
                                      ? { longitude: teamRaw.venue_lng }
                                      : {}),
                                  }
                                : {}),
                            }));
                ...
                <View style={[styles.formSection, { zIndex: 10 }]}>
                  ...
                  <View style={[styles.geocodeOption, { marginTop: 12 }]}>
                    <Pressable
                      ...
                      onPress={() =>
                        setFormData(prev => ({ ...prev, autoGeocode: !prev.autoGeocode }))
                      }
                    >
                      <View
                        style={[
                      ...
                      <View style={{ flex: 1, marginLeft: 12 }}>
                        ...
                        <Text
                          style={[styles.geocodeHelp, { color: Colors[colorScheme].mutedText }]}
                        >
                      ...
                      <View style={styles.formRow}>
                        <View style={{ flex: 1, marginRight: 8 }}>
                          <Text
                            style={[
                              styles.label,
                              { fontSize: 14, color: Colors[colorScheme].text },
                            ]}
                          >
                            Latitude
                          </Text>
                ...
                <View style={styles.formSection}>
                  ...
                  <TextInput
                    ...
                    onChangeText={text => {
                      ...
                      setFormData(prev => ({
                        ...prev,
                        attendance: text === '' ? null : isNaN(num) ? null : num,
                      }));
                    }}
                  />
                </View>
