...
export function NotificationTapHandler() {
  ...
  const pushRoute = useCallback(
    (target: Href | string | { pathname: string; params?: Record<string, string> }) => {
  ...
  const processNotificationResponse = useCallback(
    (response: NotificationResponseLike) => {
      ...
      if (isProtected && !user) {
        ...
        captureBreadcrumb(
          'Push notification redirected to sign-in',
          'notifications.tap',
          {
            type: data.type,
      ...
      try {
        switch (data.type) {
          ...
          case 'game_reminder': {
            ...
            if (eventId) {
              pushRoute(buildEventDetailRoute(eventId));
            }
            break;
          }
          ...
          case 'event_updated': {
            ...
            if (evtId) {
              pushRoute(buildEventDetailRoute(evtId));
            }
            break;
          }
