...
: "${API:?Set API to the production API base URL}"
: "${DB:?Set DB to the production DATABASE_URL}"
: "${ADMIN_EMAIL:?Set ADMIN_EMAIL to an existing verified admin account email}"
: "${ADMIN_PASSWORD:?Set ADMIN_PASSWORD to that admin account password}"
