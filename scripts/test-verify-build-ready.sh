...
echo "  1. Temporarily change the Sentry plugin org/project in app.json"
echo "  2. Run: bash scripts/verify-build-ready.sh"
echo "  3. Should see error about invalid repo-managed Sentry config"
...
echo "  - ios/android sentry.properties values"
echo "  - That eas.json does not override org/project"
