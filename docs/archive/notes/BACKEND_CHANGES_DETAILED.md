...
```html
<a href="{{privacy_policy_url}}">Privacy</a> <a href="{{community_guidelines_url}}">Guidelines</a>
```
...
const result = await sendPasswordResetEmail('test@example.com', 'reset-code-123', 'Test User');
...
<a href="https://varsityhub.app/privacy">Privacy</a>
<!-- Works! -->
```
