  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          VarsityHub is the ultimate platform for sports team management, social connections, and
          athlete development.
        </p>
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <p>Hello {{adminName}},</p>
        <p>
          <strong>{{requestorName}}</strong> has requested to join your team
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          Your request to join <strong>{{teamName}}</strong> has been
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          You can still explore other teams and communities on VarsityHub or reach out to team
