...
| Missing agreement | | | Redirect to agreement | | | |
...
| Check | Result | Notes |
|---|---|---|
| Missing-agreement account recovers after acceptance without forced relogin | | |
...
|---|---|---|
| Coach-approval follow-up to agreement | | |
