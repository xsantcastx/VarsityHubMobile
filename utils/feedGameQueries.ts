 ...
 * server-computed live_until (utils/liveWindow.ts), so a normal 1h event still
 * drops into the past recap on time and all-day events stay live for 12h.
 */
export const MAX_LIVE_WINDOW_HOURS = 12;
