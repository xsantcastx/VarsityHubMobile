...
| **codex.ts**                          | LLM integration wrapper used by the in-app Codex assistant.                                                                                                                                                                                 |
| **base44Client.js / integrations.js** | Legacy Base44-backed integration bridge still used by `codex.ts`.                                                                                                                                                                           |
