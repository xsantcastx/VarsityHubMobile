...
export const ONBOARDING_REDUCER_STATE_KEY = 'onboarding_reducer_state';

/** Clear onboarding storage. Call on logout so no previous session persists. */
export async function clearOnboardingStorage(): Promise<void> {
  try {
    await AsyncStorage.multiRemove([ONBOARDING_STATE_KEY, ONBOARDING_PROGRESS_KEY, ONBOARDING_REDUCER_STATE_KEY]);
  } catch {}
}
